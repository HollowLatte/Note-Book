import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as o,a as n,d as s,b as c,e as l}from"./app-e1663f36.js";const i={},r=l(`<h2 id="读取嵌套配置" tabindex="-1"><a class="header-anchor" href="#读取嵌套配置" aria-hidden="true">#</a> 读取嵌套配置</h2><p>例如现在application.yml中有如下的配置：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">websocket</span><span class="token punctuation">:</span>
